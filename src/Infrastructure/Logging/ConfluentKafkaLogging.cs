...
public class ConfluentKafkaLogging : IConfluentKafkaLogging
{
    ...
    private const string DefaultElasticIndexName = "_NTLPLATFORM_-_NTLDOMAIN_-_NTLCOMPONENT_-environment";
    private const string KafkaIndexConfigKey = "KafkaOptions:Index";

    private readonly string _elasticIndexName;
    private readonly ILogger _logger;

    private IKafkaProducer<ApplicationLog> _kafkaApplicationLogProduce;
    private IKafkaProducer<MessageLogger> _kafkaMessageLoggerProduce;

    public ConfluentKafkaLogging(IConfiguration configuration, ILogger<ConfluentKafkaLogging> logger, IKafkaProducer<ApplicationLog> kafkaApplicationLogProduce,
            IKafkaProducer<MessageLogger> kafkaMessageLoggerProduce)
    {
        ...
        _elasticIndexName = DefaultElasticIndexName;
